...
This is a simple REST API that takes a TeX string and generates a PDF. Installed packages give preference to the rendering of chess games with diagrams, thanks to the `xkak` package.
